var DataHandler = (function () {
    ...
    DataHandler.prototype.initRegionData = function () {
        ...
        for (var key in G.regionListJSON) {
            ...
            G.GV.regions.push(new Region(i, obj.name, obj.food, obj.floodType, obj.citySite, obj.landConn, obj.seaConn, obj.tokenSize, obj.iconXY, obj.cityXY, obj.tokenSpots, obj.shipSpots));
            i++;
        }
    };
